...
// Thêm môn học
function addSubject(name, credits, grade, scale) {
    const subject = {
        id: nextId++,
        name: name.trim(),
        ...
        inputScale: scale,
        point4: scale === '10' ? convert10To4(parseFloat(grade)) : parseFloat(grade),
        point10: scale === '10' ? parseFloat(grade) : convert4To10(parseFloat(grade))
    };
...
document.getElementById('subjectForm').addEventListener('submit', function(e) {
    ...
    // Thêm môn
    addSubject(name, credits, grade, scale);
